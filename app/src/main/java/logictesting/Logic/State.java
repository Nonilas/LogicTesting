...
public class State {
    ...
    public State(Board board, Simulation simulation){
        this.board = board;
    ...
    public void saveStateToCSV() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("simulation_data.csv", true))) {
    ...
    public void setState(){
        ...
        playable = false;
        simulationNumber = simulation.numberOfSimulations;
        botNumber = board.getCurrentPlayer().getNumber();
        turnNumber = simulation.numberOfTurns;
